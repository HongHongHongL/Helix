...
def get_Ampere_FP32_conv_Helix_result(prof_dict, batch, input_channel, H, W, output_channel, kH, kW, stride, pad, backend):
...
def get_Ampere_FP32_conv_cudnn_result(batch, input_channel, H, W, output_channel, kH, kW, stride, pad):
    cmd = f'{root_path}/build/bin_fp32/cudnn_fp32 {batch} {input_channel} {H} {W} {output_channel} {kH} {kW} {stride} {pad} 1'
    result = os.popen(cmd)
