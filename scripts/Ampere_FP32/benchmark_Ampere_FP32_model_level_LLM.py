...
def Ampere_FP32_Helix_model_level_LLM_benchmark(backend = "cuda"):
    ...
    for M, N, K in Bert_MNKList:
        cost, _ = get_Ampere_FP32_gemm_Helix_result(prof_dict, M, N, K, backend)
...
def Ampere_FP32_cublas_model_level_LLM_benchmark():
    ...
    for M, N, K in Bert_MNKList:
        cost, _ = get_Ampere_FP32_gemm_cublas_result(M, N, K)
...
if __name__ == "__main__":
    ...
    Ampere_FP32_Helix_model_level_LLM_benchmark(backend="cuda")
    Ampere_FP32_Helix_model_level_LLM_benchmark(backend="tvm")
