...
from Ampere_FP16.profile_Ampere_FP16 import profile_Helix_Ampere_FP16_gemm_kernel
from Ampere_FP32.profile_Ampere_FP32 import profile_Helix_Ampere_FP32_gemm_kernel
from x86_CPU.profile_x86_CPU import profile_Helix_x86_CPU_gemm_kernel
from ARM_CPU.profile_ARM_CPU import profile_Helix_ARM_CPU_gemm_kernel
