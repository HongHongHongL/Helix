...
from Ampere_FP16_gemm import get_Ampere_FP16_gemm_Helix_result, get_Ampere_FP16_gemm_cublas_result

root_path = os.getcwd()

def Ampere_FP16_Helix_op_level_GEMM_benchmark(backend):
