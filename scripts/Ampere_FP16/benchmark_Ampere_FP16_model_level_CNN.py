...
def Ampere_FP16_Helix_model_level_CNN_benchmark(backend = "cuda"):
...
def Ampere_FP16_cudnn_model_level_CNN_benchmark():
    ...
    for batch, input_channel, H, W, output_channel, kH, kW, stride, pad in AlexNet_shape_list:
        cost, _ = get_Ampere_FP16_conv_cudnn_result(batch, input_channel, H, W, output_channel, kH, kW, stride, pad)
...
if __name__ == "__main__":
    ...
    Ampere_FP16_Helix_model_level_CNN_benchmark(backend="cuda")
    Ampere_FP16_Helix_model_level_CNN_benchmark(backend="tvm")
