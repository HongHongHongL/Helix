...
from Ampere_FP16.benchmark_Ampere_FP16_conv import Ampere_FP16_Helix_op_level_Conv_benchmark, Ampere_FP16_cublas_op_level_Conv_benchmark
...
from Ampere_FP32.benchmark_Ampere_FP32_conv import Ampere_FP32_Helix_op_level_Conv_benchmark, Ampere_FP32_cublas_op_level_Conv_benchmark
...
from x86_CPU.benchmark_x86_CPU_conv import x86_CPU_Helix_op_level_Conv_benchmark, x86_CPU_onnxruntime_op_level_Conv_benchmark, x86_CPU_MKL_op_level_Conv_benchmark
...
func_dict = {
    ...
    ('Conv', 'Ampere_FP16', 'cublas'): Ampere_FP16_cublas_op_level_Conv_benchmark,
    ...
    ('Conv', 'Ampere_FP32', 'cublas'): Ampere_FP32_cublas_op_level_Conv_benchmark,
    ...
    ('Conv', 'x86_CPU', 'MKL'): x86_CPU_MKL_op_level_Conv_benchmark,
